...
Dans `results/intermediates/`, on trouve notamment :
...
Dans `results/other_results/`, on trouve notamment :

- `df_export_review.csv`
- `df_index.csv`

Ces fichiers sont utiles pour une lecture plus détaillée, mais ne constituent pas le cœur de l’évaluation.
